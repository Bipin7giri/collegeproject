...
{
    public $usersData,$name=[],$count=[], $flightData,$flightName=[],$fCount=[],$totalSales;
    ...
    public function mount(){
       ...
       $this->count[]=$u->total;
        ...
        $this->flightData = TicketDetails::select(DB::raw('flight_details_id'),DB::raw('flight_name'),DB::raw('count(*) as total'))
