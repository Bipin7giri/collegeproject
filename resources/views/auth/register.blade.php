<x-guest-layout>
    ...
    <nav class="relative px-44 pb-6 pt-8 flex items-center  justify-between sm:h-10 lg:justify-start" aria-label="Global"
            style="background-color: #520c30e0">
    
                <a href="{{ route('home') }}" class="font-bold text-3xl font-mono text-white pr-20 pb-5 ">Fly Nepal</a>
