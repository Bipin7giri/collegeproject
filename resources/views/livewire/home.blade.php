<div>
    ...
    <h1 class="font-bold font-serif text-3xl px-10 py-5">
        Travel safely with us
    </h1>
    <p class="px-10  text-gray-500">
        As one of the largest and most experienced global airlines throughout the COVID-19 crisis, you can rely on
        us to take you on your next journey safely.
    </p>
        ...
        <div class="owl-carousel">
            @foreach ($flightDetails as $flightDetail)
                <div class="w-full drop-shadow-xl   rounded-2xl bg-white border-2">
                    ...
                    <a href="{{ route('login') }}">
                        <img src="{{ asset('img/cards.PNG') }}" alt="pic"
    ...
    <section class="pb-2">
        <img src="{{ asset('img/flyNepal.PNG') }}" alt="pic">
    </section>


    <section>
        <img src="{{ asset('img/banner2.PNG') }}" alt="pic">
    </section>
