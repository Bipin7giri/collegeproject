                            ...
                            <div class="w-full p-3 border-b border-gray-200">
                                <div class="mb-5 flex justify-around">
                                    <label for="type1" class="flex items-center cursor-pointer">
                                        <input type="radio" wire:model="payment_type" class="form-radio h-5 w-5 text-indigo-500" value="MasterCard" name="card"
                                            id="type1">
                                    ...
                                    <label for="type2" class="flex items-center cursor-pointer">
                                        <input type="radio"   wire:model="payment_type" class="form-radio h-5 w-5 text-indigo-500" 
                                            id="type2" name="card" value="PayPal">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div>
                                            <input
                                                ...
                                                placeholder="John Smith" wire:model="card_name" type="text" />
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <div>
                                            <input
                                                class="w-full px-3 py-2 mb-1 border border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors"
                                                placeholder="0000 0000 0000 0000" wire:model="card_no" type="text" />
                                        </div>
                                    </div>
